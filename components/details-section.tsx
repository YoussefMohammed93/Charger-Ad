...
export const DetailsSection = () => {
  return (
    <section className="bg-[#FAF3EA] p-6 my-20 pt-20">
      {/* First Block */}
      <motion.div
      ...
      >
        <div className="absolute top-20 -left-6 opacity-50 sm:opacity-100">
          <Image
            src="/vector-1.png"
            alt="vector"
            width={300}
      ...
      <motion.div
        ...
        transition={{ duration: 0.7, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.3 }}
        className="relative flex flex-row-reverse py-10 sm:py-20 mb-20"
      >
        <div className="absolute top-40 -right-6 opacity-50 sm:opacity-100">
          <Image
            src="/vector-3.png"
            alt="vector"
            width={300}
